...
export function Navbar() {
    const { cartQuantity, handleCart } = useShoppingCart();
    ...
    return (
        <NavbarBs sticky="top" className="bg-white shadow-sm mb-3">
            <Container>
                ...
                {cartQuantity > 0 &&
                    <Button style={{ width: '3rem', height: "3rem", position: "relative" }} variant="outline-primary" className="rounded-circle" onClick={() => handleCart()}>
                        <svg
